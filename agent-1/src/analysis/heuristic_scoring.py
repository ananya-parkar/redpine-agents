# agent-1/src/analysis/heuristic_scoring.py
from datetime import datetime, timezone, timedelta
from typing import Dict, List
from src.core.config import DISTRESS_KEYWORDS, REVIEW_LOOKBACK_MONTHS, RENOVATION_KEYWORDS, PROPERTY_AGE_THRESHOLD_YEARS
