# agent-1/src/dashboard/dashboard_charts.py
import re, zipfile
import pandas as pd
...
from src.dashboard.dashboard_metrics import build_signal_summary
from src.dashboard.dashboard_components import _font, _fill, _align, _apply
